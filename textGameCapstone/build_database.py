...
def seed_database():
    ...
    try:
        ...
        client.drop_database("text_adventure_db")
        print("Cleared existing 'text_adventure_db'.")

        # Create/Access the database and collection
        db = client["text_adventure_db"]
        ...
        print(f"Successfully inserted {len(result.inserted_ids)} room documents into 'text_adventure_db'.")
